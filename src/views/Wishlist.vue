          ...
          <li v-for="(movie, index) in movies" :key="movie.id">
            ...
            >
              ...
              <div class="my-8 col-span-2">
                ...
                <span class="grid grid-cols-1 m-auto mt-1 mb-1">
                  <a
                  ...
                  >
                    ...
                    <span class="text-base mr-5"> 😌 </span>

                    Finally! i've watched it
                  </a>
           ...
           <div
          class="max-h-screen max-w-7xl mx-auto sm:px-6 lg:px-8"
          v-else
        >
            <p class="text-center text-xl text-gray-400">No movies in list add some :(</p>
...
export default {
  ...
  methods: {
    getMovies() {
      ...
      fetch("https://metaflix.asaas.ly/api/movies/wishlist", {
        method: "GET",
        headers: {
    ...
    remove(movie, key) {
      ...
      fetch("https://metaflix.asaas.ly/api/movies", {
        ...
        body: JSON.stringify({
          ...
          title: movie.title,
          tmbd_vote_average: movie.tmbd_vote_average,
